...
''';
  ...
  Uri linkedinUrl = Uri.parse(
    "https://www.linkedin.com/in/chingiz-zaidov-86241b328/",
  );
        ...
        return AlertDialog(
          ...
          content: Text(
            ...
            style: GoogleFonts.montserrat(
              textStyle: TextStyle(fontSize: 19, color: Colors.amber),
            ),
          ),
        );
      },
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            ...
            style: GoogleFonts.montserrat(
              textStyle: TextStyle(fontSize: 17, color: Colors.amber),
            ),
          ),
        );
      },
        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              boxShadow: [
                BoxShadow(color: Colors.black, blurRadius: 20, spreadRadius: 7),
              ],
            ),
          ),
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text(
              "Learning constantly, Building confidently",
              maxLines: 2,
              style: GoogleFonts.montserrat(
                color: Colors.white30,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      ...
                      icon: Icon(Icons.phone, size: 25, color: Colors.amber),
                      tooltip: "Call me",
                    ),
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      onPressed: () {
                        ShowEmailInfo(context);
                      },
                      icon: Icon(Icons.email, size: 25, color: Colors.amber),
              ...
              children: [
                for (int i = 0; i < drawerSections.length; i++)
                  MouseRegion(
                    ...
                    child: AnimatedScale(
                      //AnimatedScale ile sadece text in hover olanda olcusunu artirdiq
                      scale: hoveredIndex == i ? 1.06 : 1.0, //0.06 faiz artdi
                      duration: Duration(
                        milliseconds: 200,
                      ), //0.2 saniyeye kecid edir
                      child: ListTile(
                        title: Text(
